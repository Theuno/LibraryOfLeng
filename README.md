...
* C# and .NET Core: Leng's backend is built on C# and .NET Core, providing a solid foundation for robust and efficient performance. .NET Core's cross-platform capabilities ensure Leng runs smoothly on various operating systems.
...
* Blazor: Leng's frontend is crafted using Blazor, a modern web framework that allows us to create interactive and dynamic user interfaces with C# and Razor components. No need to rely solely on JavaScript—C# is our go-to language for frontend magic.
